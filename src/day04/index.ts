...
function processPart1(boards:number[][][], numbers: number[]) {
...
function processPart2(boards: number[][][], numbers: number[]) {
...
processPart1(boards, numbers);
console.log('PART 2');
processPart2(boards, numbers);
